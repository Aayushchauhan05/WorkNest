...
function Page() {
  ...
  return (
    <div className="flex w-full h-screen">
      ...
      <div className={`fixed md:relative p-6 bg-cyan-800 transition-transform transform z-10 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 md:flex text-gray-50 w-[70%] md:w-[20%]`}>
        <div className="flex flex-col gap-6">
          ...
          <nav className="flex flex-col w-auto h-screen gap-2 top-10 relative">
            ...
            <Link href={"/freelancerDashboard/oracleVerify"} className="flex items-center gap-3 px-3 py-2 transition-colors rounded-md bg-gray-800">
              Oracle Verify
            </Link>
          </nav>
        </div>
        ...
        <header className="bg-gray-900 shadow-sm dark:bg-gray-900">
          <div className="container flex items-center justify-between px-6 py-4 mx-auto">
            <div className="flex items-center gap-4">
              ...
              <div>
              <h1 className="text-3xl font-bold text-white dark:text-gray-50 mt-2">  Oracle Verify</h1>
              </div>
            </div>
            <div className="flex items-center gap-4">
         ...
         {!isVerified ? (
           ...
           {isApplying && <h2 className='opacity-50 text-xl'>Your request has been sent for verification.</h2>}
            ...
            <>
              ...
              <h2 className='opacity-50 text-xl'>You are verified now you are Oracle Verified Now. </h2>
            </>
          )}
          ...
          {isVerified && (
            ...
            <h2 className='text-3xl '>Now You are Oracle Verified Enjoy !!</h2>
      ...
      {/* Right side Main Container */}
      <main className=" container bg-gray-950 p-6 text-white ">
      <header className="bg-gray-900 shadow-sm dark:bg-gray-900">
         <div className="container flex items-center justify-between px-6 py-4 mx-auto">
           <div className="flex items-center gap-4">
             <button onClick={toggleMenu} className="inline-flex items-center justify-center w-10 h-10 text-sm font-medium transition-colors rounded-md whitespace-nowrap ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground md:hidden">
        ...
        <button
             onClick={toggleShowUsers}
              className="px-4 py-2 items-center mt-5 bg-cyan-700 text-white rounded-md hover:bg-cyan-800"
            >
        ...
        {showUsers && (
         ...
         <div className='w-full h-auto  mt-10 opacity-80 flex rounded-2xl items-center justify-center '>
          <h2 className='text-white text-2xl'>Before applying for the Oracle verification, you should have a minimum of 2 years of experience.</h2>
         </div>
        </main>
      </div>
    </div>
