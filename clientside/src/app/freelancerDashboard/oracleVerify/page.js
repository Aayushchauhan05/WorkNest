      ...
      <div className="flex flex-col w-full">
        <header className="bg-gray-900 shadow-sm dark:bg-gray-900">
          <div className="container flex items-center justify-between px-6 py-4 mx-auto">
            <div className="flex items-center gap-4">
              ...
              <div>
              <h1 className="mt-2 text-3xl font-bold text-white dark:text-gray-50">  Oracle Verify</h1>
              </div>
            </div>
            <div className="flex items-center gap-4">
        ...
        {userExp>=2?
         ...
         {!isVerified ? (
           ...
           {isApplying && <h2 className='text-xl opacity-50'>Your request has been sent for verification.</h2>}
            ...
            <>
              ...
              <h2 className='text-xl opacity-50'>You are verified now you are Oracle Verified Now. </h2>
            </>
          )}
         ...
         <div className='flex items-center justify-center w-full h-auto mt-10 opacity-80 rounded-2xl '>
          <h2 className='text-2xl text-white'>Before applying for the Oracle verification, you should have a minimum of 2 years of experience.</h2>
         </div>
        </main>
      </div>
    </div>
